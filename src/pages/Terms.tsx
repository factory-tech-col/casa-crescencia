...
export default function Terms() {
  return (
    <>
      <SEO title="Términos y Condiciones" description="Términos y condiciones de uso de Casa Crescencia" />
      <div className="container-custom py-12 max-w-3xl">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Al acceder y utilizar el sitio web de Casa Crescencia, usted acepta estos términos y condiciones
          ...
          <section>
            ...
            <p>
              ...
              es propiedad de Casa Crescencia y está protegido por las leyes de propiedad intelectual colombianas.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Casa Crescencia no será responsable por daños indirectos, incidentales o consecuentes
